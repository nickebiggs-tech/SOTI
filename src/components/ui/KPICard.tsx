  ...
  return (
    <div className={cn('relative bg-white rounded-xl border border-slate-200 p-4 sm:p-5 kpi-hover overflow-hidden group', className)}>
      ...
      <div className="flex items-start justify-between mb-2 sm:mb-3">
        ...
        {icon && (
          <div className="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center text-primary transition-transform duration-300 group-hover:scale-110">
            {icon}
          </div>
        )}
      </div>
      ...
      {delta !== undefined && (
        <div className="flex items-center gap-1.5 mt-2 animate-fade-in" style={{ animationDelay: '200ms' }}>
          <div className={cn(
            'flex items-center gap-1 px-1.5 py-0.5 rounded-md text-xs font-semibold transition-colors',
